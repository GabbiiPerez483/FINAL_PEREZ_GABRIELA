Public Class FRMPROFESORES
    ...
    Private Sub FRMPERSONAS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Comando.Connection = Conexion
        Comando.CommandType = CommandType.Text
        Comando.CommandText = "Select * from Titulos"
        ...
        If Operacion = "Modificar" Then
            ...
            Comando.Connection = Conexion
            Comando.CommandType = CommandType.Text
            Comando.CommandText = "Select * from Profesores where Legajo_Prof= '" & IDPERSELECT & "'"
                                        ...
                                        If dtp_fecha.Text < Date.Today Then
                                            If txtEstCivil.Text.Trim <> "" Then
                                                If cmbTitulo.SelectedIndex > -1 Then
                                                    Ok = True
                                                Else
                                                    MessageBox.Show("Seleccione un titulo", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
                                                End If
                                            Else
    ...
    Private Sub btn_registrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_registrar.Click
        ...
        If Validar() = True Then
            If Operacion = "Alta" Then
                ...
                Comando.Connection = Conexion
                Comando.CommandType = CommandType.Text
                Comando.CommandText = "select * from Profesores where Nro_Doc='" & txt_dni.Text & "'"
                ...
                If Tabla.Rows.Count = 0 Then
                    ...
                    Cadena = "INSERT into Profesores (Ape_Nombre,Cod_Doc,Direccion,Email,Est_Civil,Fecha_Nac,Nro_Doc,Sexo,cod_titulo,Telefono) VALUES("
                    ...
                    Else
                        Cadena = Cadena & "'M',"
                    End If
                    Cadena = Cadena & cmbTitulo.SelectedValue & ","
            ...
            Else
                ...
                Comando.Connection = Conexion
                Comando.CommandType = CommandType.Text
                Comando.CommandText = "select * from Profesores where Nro_Doc='" & txt_dni.Text & "' and Legajo_Prof <> " & IDPERSELECT
                ...
                If Tabla.Rows.Count = 0 Then
                    ...
                    End If
                    Cadena = Cadena & "Cod_Titulo= '" & cmbTitulo.SelectedValue & "',"
